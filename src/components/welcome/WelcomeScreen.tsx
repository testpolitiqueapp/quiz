        ...
        <div className="relative z-[2] flex max-w-4xl flex-col items-center px-1 pt-4 sm:pt-0">
          ...
          <div className="mt-4 mb-5 animate-fade-in-up">
            <span className={twMerge(
              ...
              <div className="flex h-6 w-9 overflow-hidden rounded-full shadow-sm ring-1 ring-black/10">
                <div className="h-full w-1/3 bg-[#002395]"></div> {/* Bleu France */}
                <div className="h-full w-1/3 bg-white"></div>    {/* Blanc */}
                <div className="h-full w-1/3 bg-[#ED2939]"></div> {/* Rouge France */}
              </div>
